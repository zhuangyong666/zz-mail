            ...
            <div class="card bg-primary">
              <div class="card-body clearfix">
                <div class="pull-left">
                  ...
                  <p class="h3 text-white m-b-0">${showTipsUrlText}<a href="${showTipsUtl}" style="color:red;margin-right:20px;"></a><a href="javascript:void(0)" class="btn btn-danger" id="order-auth-btn">${showTipsBtnText}</a></p>
