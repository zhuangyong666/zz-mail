  ...
  <#include "../common/top_header.ftl"/>
    ...
    <div class="container">
   		<div class="main center">
            ...
            <p class="h3 text-white m-b-0" style="font-size:16px;margin-top:10px;"><a href="javascript:void(0)" style="color:red;margin-right:20px;"></a><a href="javascript:void(0)" class="btn btn-danger" id="order-auth-btn"></a></p>
        	</#if>
        </div>
